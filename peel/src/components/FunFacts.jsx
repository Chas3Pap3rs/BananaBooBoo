...
function FunFacts() {
  ...
  useEffect(() => {
    axios.get('http://localhost:4000?category_id=3')
      .then(res => {
  ...
  return (
    <div className="funfacts-container">
      ...
      <p>Who doesn't love fun?! Post your fun fact questions here!</p>
      <br />
      ...
      {isLoggedIn && isAuthenticated && <Link to='/post' className="edit" state={{ category_id: '3' }}>Post Question</Link>}
    </div>
  );
}
